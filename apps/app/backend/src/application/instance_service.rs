...
impl InstanceService {
    ...
    pub async fn list_instances(&self) -> Result<Vec<crate::domain::instances::GameInstance<crate::domain::instances::Stopped>>, InstanceServiceError> {
        self.instance_repo.list_instances().await
            .map_err(|_| InstanceServiceError::NotFound(InstanceId::new(uuid::Uuid::nil())))
    }
}
