...
Amberite Core V2 manages Minecraft server instances — start/stop servers, console access, configuration, and user scripting via JavaScript macros. REST API with WebSocket console streaming.
...
| Command | Description |
|---------|-------------|
| `cargo run -- --amberite-path <dir>` | Start server |
| `cargo build` | Build |
