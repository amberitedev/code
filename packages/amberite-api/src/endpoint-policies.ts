...
export const coreEndpointPolicies = Object.freeze({
	...
	'core.access.list': read,
	'core.access.grant': mutate,
	'core.access.update': mutate,
	'core.access.remove': destructive,
	'core.instance_access.list': read,
	'core.instance_access.grant': mutate,
	'core.instance_access.update': mutate,
	'core.instance_access.remove': destructive,
	'core.activity.list': read,
	'core.instance_activity.list': read,
...
const routePolicies: Array<[RegExp, string]> = [
	...
	[/^GET \/instances\/[^/]+\/access$/, 'core.instance_access.list'],
	[/^POST \/instances\/[^/]+\/access$/, 'core.instance_access.grant'],
	[/^PATCH \/instances\/[^/]+\/access\/[^/]+$/, 'core.instance_access.update'],
	[/^DELETE \/instances\/[^/]+\/access\/[^/]+$/, 'core.instance_access.remove'],
	[/^GET \/instances\/[^/]+\/activity$/, 'core.instance_activity.list'],
