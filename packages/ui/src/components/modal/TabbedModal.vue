		...
		<div class="grid grid-cols-[auto_1fr] p-6 pb-3 pr-0">
			...
			>
				<component
					...
					:class="[
						'flex gap-2 items-center text-left rounded-xl border border-solid px-4 py-2 text-nowrap font-semibold cursor-pointer active:scale-[0.97] transition-all no-underline',
						!tab.href && selectedTab === index
							? props.selectedStyle === 'wireframe'
				...
				>
					...
					<span
						v-if="tab.badge"
						class="rounded-full border border-solid border-brand px-1.5 py-0.5 text-xs font-bold bg-brand-highlight text-brand"
					>
